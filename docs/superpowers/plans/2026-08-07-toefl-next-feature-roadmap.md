...
- R1／R2 完成目標時合法略過 drill 並強制 follow-up；R2 未完成時先詢問 learner，僅在同意後要求列出 source、1–2 個 lineage target codes、1–8 題與完成條件；拒絕時須保留 learner decision、提供建議型 follow-up 並結束 chain。
...
- 完成 revision 的 follow-up 為必要 heading；有精修空間時只提供 excerpt-based 建議，不得附加題目；零項結果必須附 1–3 個實際 learner excerpt 的 naturalness audit 與 transfer suggestion，不能只輸出固定句跳過檢查。
...
| --- | --- | --- | --- |
<!-- BUG-CAPTURE-LEDGER -->
| `BUG-20260820-002` | reported | Interview local transcription reports unavailable audio compute device | [reproduction](tracker/bug-reports/BUG-20260820-002/reproduction.md) | `v1` `sha256:4651e5d5cdf4c1459c16ac58e37a192cbf5afa1ae6ef85755116254801bb609e` |

| `BUG-20260820-001` | reported | Listen and Repeat omits a detected item after item 6 | [reproduction](tracker/bug-reports/BUG-20260820-001/reproduction.md) | `v1` `sha256:976d4111be5ff3b5b27140e5cb698add2d0306c4154650bebb78d3209a5ecc1c` |
...
| `BUG-20260812-004` | fixed_verified | Revision feedback mixes newly found issues with prior target tracking | [reproduction](tracker/bug-reports/BUG-20260812-004/reproduction.md) | `v1` `sha256:10c171de59e5a9d4e0f14698eef48571602cf7ab4147ae630d64c13750bfa860` |

| `BUG-20260812-003` | fixed_verified | Targeted drill generation rejects education discussion prompt | [reproduction](tracker/bug-reports/BUG-20260812-003/reproduction.md) | `v1` `sha256:abb66306450edddfd400e2fd2056bca69d740a9d32a9f99fe79f1e5a6989848f` |

| `BUG-20260812-002` | fixed_verified | Completed writing revision skips mandatory actionable follow-up | [reproduction](tracker/bug-reports/BUG-20260812-002/reproduction.md) | `v1` `sha256:5c385393e2f072c3dbe9ed1a65af2d751e850adc8ded629901858d4e5dd75186` |
